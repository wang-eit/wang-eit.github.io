...
window.onload = function (){
    ...
    function LoadData(){
        ...
        var PhDDiv = document.querySelector('.phd_bj');
        var PhDStu = allStudentData.PhDs;
        for (let j = 0; j < PhDStu.length; j++) {
            ...
            pNode.append(PhDStu[j].eduBj_2,document.createElement('br'));
            aNode.href="mailto:"+PhDStu[j].selfEmail;
            aNode.append(PhDStu[j].selfEmail);
